...
#ifndef circulation_fan3_H
#define circulation_fan3_H

#include <Arduino.h>
#include <ArduinoJson.h> // WICHTIG: Damit JsonObject bekannt ist
enum circulation_fan3Mode {
    circulation_fan3_MODE_MANUAL,
    circulation_fan3_MODE_NATURAL,
    circulation_fan3_MODE_CHAOTIC
};
