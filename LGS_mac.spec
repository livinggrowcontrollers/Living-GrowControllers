...
app = BUNDLE(
    ...
    info_plist={
        'CFBundleName': 'LivingGrowControllers',
        'CFBundleDisplayName': 'LivingGrowControllers',
        'CFBundleGetInfoString': "LGS Analytics Dashboard",
        'CFBundleIdentifier': "com.lgs.dashboard",
        'CFBundleVersion': "2.3.1",
        'CFBundleShortVersionString': "1.2.0",
        'NSHighResolutionCapable': 'True',
        'NSHumanReadableCopyright': "Copyright © 2026 LGS Dominik Rosenthal Alle Rechte vorbehalten."
    }
)