...
class I18N:
    ...
    _translations = {
        "en": {
            ...
            "settings.graph_refresh_interval": "Graph Refresh Interval",
        ...
        "es": {
            ...
            "settings.graph_refresh_interval": "Intervalo de actualización del gráfico",
        ...
        "de": {
            ...
            "settings.tile_graph_window": "Graph Window (samples)",
            "settings.graph_refresh_interval": "Graph-Aktualisierungsintervall",
